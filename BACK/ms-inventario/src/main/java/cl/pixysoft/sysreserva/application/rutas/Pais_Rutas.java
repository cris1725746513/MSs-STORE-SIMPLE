...
import cl.pixysoft.sysreserva.application.controladores.Pais_Controlador;
import cl.pixysoft.sysreserva.domain.puertosSalida.Pais_PuertoSalida;
...
@Path("v1/sysreserva/inventario/paises")
